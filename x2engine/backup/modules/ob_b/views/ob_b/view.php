...
include("protected/modules/ob_b/ob_bConfig.php");
...
<?php $this->renderPartial('application.components.views._detailView',array('model'=>$model, 'modelName'=>'ob_b')); ?>

<?php
$this->widget('X2WidgetList', array('block'=>'center', 'model'=>$model, 'modelType'=>'Ob_b'));
...
$this->widget('Publisher',
	array(
		'associationType'=>'ob_b',
		'associationId'=>$model->id,
		'assignedTo'=>Yii::app()->user->getName(),
		'calendar' => false
	)
);
$this->widget('History',array('associationType'=>'ob_b','associationId'=>$model->id));
?>
</div>