...
include("protected/modules/objekte/objekteConfig.php");
	...
	'linkOptions' => array (
		'onClick'=>"window.open('".
			Yii::app()->createUrl('/site/printRecord', array (
				'modelClass' => 'Objekte',
				'id' => $model->id,
				'pageTitle' => Yii::t('app', 'Objekt').': '.$model->name
			))."');"
)),
...
<?php $this->renderPartial('application.components.views._detailView',array('model'=>$model, 'modelName'=>'objekte')); ?>

<?php
$this->widget('X2WidgetList', array('block'=>'center', 'model'=>$model, 'modelType'=>'Objekte'));
$this->widget('Attachments', array('associationType' => 'objekte', 'associationId' => $model->id, 'startHidden' => true)); 
?>
...
$this->widget('Publisher',
	array(
		'associationType'=>'objekte',
		'associationId'=>$model->id,
		'assignedTo'=>Yii::app()->user->getName(),
		'calendar' => false
	)
);
$this->widget('History',array('associationType'=>'objekte','associationId'=>$model->id));
?>
</div>
