...
include("protected/modules/berichtsheft/berichtsheftConfig.php");
	...
	'linkOptions' => array (
		'onClick'=>"window.open('".
			Yii::app()->createUrl('/site/printRecord', array (
				'modelClass' => 'Berichtsheft',
				'id' => $model->id,
				'pageTitle' => Yii::t('app', 'Eintrag').': '.$model->name
			))."');"
)),
...
$modelType = json_encode("Berichtsheft");
...
<?php $this->renderPartial('application.components.views._detailView',array('model'=>$model, 'modelName'=>'berichtsheft')); ?>
...
$this->widget('Attachments', array('associationType' => 'berichtsheft', 'associationId' => $model->id, 'startHidden' => true)); 

$this->widget('X2WidgetList', array('block'=>'center', 'model'=>$model, 'modelType'=>'Berichtsheft'));
?>
...
$this->widget('Publisher',
	array(
		'associationType'=>'berichtsheft',
		'associationId'=>$model->id,
		'assignedTo'=>Yii::app()->user->getName(),
		'calendar' => false
	)
);
$this->widget('History',array('associationType'=>'berichtsheft','associationId'=>$model->id));
?>
</div>
